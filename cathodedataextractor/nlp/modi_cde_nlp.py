...
"""
import regex as re
from chemdataextractor.nlp import WordTokenizer, ChemWordTokenizer, BertWordTokenizer
from chemdataextractor.nlp.tokenize import regex_span_tokenize
...
WordTokenizer.handle_additional_regex = handle_additional_regex
WordTokenizer.span_tokenize = span_tokenize

change = ChemWordTokenizer.SPLIT.index('°')
ChemWordTokenizer.SPLIT[change] = '°(?!C)'  # \u00b0 Degrees

BertWordTokenizer.span_tokenize = span_tokenize_bert
