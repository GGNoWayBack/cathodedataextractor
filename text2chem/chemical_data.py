...
pubchem_dictionary = json.loads(open(os.path.join(__filename, "resources/terms_dictionary.json"), encoding='utf-8').read())
default_abbreviations = json.loads(open(os.path.join(__filename, "resources/acronyms_dictionary.json"), encoding='utf-8').read())
ions_table = json.loads(open(os.path.join(__filename, "resources/ions_dictionary.json"), encoding='utf-8').read())
